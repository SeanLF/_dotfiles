...
<!-- Vendored from the code-modernization plugin so it is available without
     installing the whole plugin. Self-contained, no plugin-relative
     references. Re-copy from ~/.claude/plugins/marketplaces if upstream
     changes matter. -->
